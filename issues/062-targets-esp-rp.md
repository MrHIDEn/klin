...
**Status:** 🚧 — RP2040 + RP2350 (Arm + RISC-V) via [`machine_rp`](https://github.com/klin-lang/machine_rp); ESP32-C3 Pin via [`machine_esp`](https://github.com/klin-lang/machine_esp) (minimal IDF blink)
