...
| CH32V003 (QingKe RISC-V)? | **`machine_ch32v`** — Pin…Adc ✅ `@v0.1.0` sources ([086](086-machine-ch32v.md)); **10-bit** ADC; publish when GitHub repo exists |
| GD32VF103 (Nuclei RISC-V)? | **`machine_gd32v`** — stub `@v0.0.0` ([087](087-machine-gd32v.md)); full MMIO after CH32V |
| Other PIC? | Separate ports if/when needed — not one library for all MCUs |
| DAC? | Only where the silicon has it — **yes** on ATxmega (DACB) and PIC16F18855 (DAC1); **not** on F411/F401, RP2040/2350, ESP32-C3, STM8S, megaAVR 328P/2560, CH32V003. F407-class / classic ESP32 later if needed. |
