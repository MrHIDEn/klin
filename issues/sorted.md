...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (stm32/rp/esp/stm8 Pin+Pwm+Rc; xmega/avr/pic16 Pin; UART next) | 010, 031? |
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 | 🚧 (RP+ESP+STM8 Pin+Pwm+Rc; Wi‑Fi/freestanding/SDCC open) | 010 |
