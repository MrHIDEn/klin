...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (`machine_stm32` + `machine_rp` Pin) | 010, 031? |
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 | 🚧 (RP2040+RP2350 Arm via `machine_rp`) | 010 |
