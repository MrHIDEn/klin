...
| [028](028-freertos.md) | FreeRTOS (`klin_freertos` ✅; `FromISR` ✅; blink ✅; static create open) | 🔨 | 024, 010, 021, 030 |
...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (stm32/rp/esp/stm8 Pin…Adc; avr Pin+328P buses; xmega/pic16 Pin…Dac) | 010, 031? |
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 | 🚧 (RP+ESP+STM8 Pin…Adc; Wi‑Fi/freestanding/SDCC open) | 010 |
