...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (+ ch32v Pin…Adc sources; gd32v stub) | 010, 031? |
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 / CH32V / GD32V | 🚧 (RP+ESP+STM8 ✅; CH32V sources; GD32V stub) | 010 |
| [086](086-machine-ch32v.md) | `machine_ch32v` CH32V003 QingKe Pin…Adc | 🔨 (`@v0.1.0` sources; publish pending) | 061, 062 |
| [087](087-machine-gd32v.md) | `machine_gd32v` GD32VF103 Nuclei template → Pin…Adc | 💭 stub `@v0.0.0` | 061, 086 |
