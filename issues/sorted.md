...
| [029](029-async-event-loop.md) | Event loop / async·await (lib `@v0.2.0` ✅; phase 3 RTOS examples ✅; phase 4 async MVP ✅; IDE ⏳) | 🔨 | 018?, 028?, 049? |
...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (`machine_stm32` + `machine_rp` + `machine_esp` Pin) | 010, 031? |
