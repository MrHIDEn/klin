...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (+ ch32v `@v0.1.0` / gd32v `@v0.2.0`) | 010, 031? |
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 / CH32V / GD32V | 🚧 (RP+ESP+STM8+CH32V+GD32V Pin…Adc ✅) | 010 |
...
| [087](087-intellij-plugin.md) | IntelliJ plugin for Klin (LSP client + highlight; not full PSI) | 💭 0% (howto ✅) | 086, 093 |
