...
| [061](061-micropython-machine-api.md) | MicroPython-style `machine` API (PWM, UART, …) | ✅ (+ ch32v/gd32v Pin…Adc `@v0.1.0`) | 010, 031? |
...
| [087](087-machine-gd32v.md) | `machine_gd32v` GD32VF103 Nuclei Pin…Adc | ✅ `@v0.1.0` | 061, 086 |
