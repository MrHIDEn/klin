...
Użytkownik / contributor czyta README + `note/` + przykłady i widzi pełny
...
- `note/06-cli.md` — subkomendy i flagi
- `note/07-interpolacja.md` — składnia 016
- `stdlib/README.md` — `io` + `testing`
- `examples/README.md` — sync z plikami na dysku

## Poza zakresem

- Tłumaczenie `issues/` / `note/` na EN
